...
const Premiere_L = () => {
  const { premiere, fetchAllElevePremiereL, deleteEtudiant } = useClientContext()
  useEffect(() => {
  ...
  return (
    <>
      <CRow>
        ...
        <br />
        <br />
        <DataTable columns={columns} data={premiere} fixedHeader pagination dense={false} />
      </CRow>
    </>
  )
}

export default Premiere_L
